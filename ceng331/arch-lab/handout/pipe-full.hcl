...
#
# I implemented leaq instruction
# Because my code has a lot of mrmovq followed by rmmovq, I changed e_valA, and added this condition to F_stall, D_stall
# D_bubble and E_bubble, which decreased the cpe to 11.09 
####################################################################
#/* $begin pipe-all-hcl */
####################################################################
